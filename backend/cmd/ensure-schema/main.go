...
// migrationSQL must be kept in sync with migrations/001_initial_schema.up.sql
const migrationSQL = `
...
CREATE INDEX IF NOT EXISTS idx_relationships_trainer ON relationships(trainer_id, status);
CREATE INDEX IF NOT EXISTS idx_relationships_athlete ON relationships(athlete_id, status);
...
CREATE INDEX IF NOT EXISTS idx_coaching_requests_athlete ON coaching_requests(athlete_id, status);
CREATE INDEX IF NOT EXISTS idx_coaching_requests_trainer ON coaching_requests(trainer_id, status);
...
CREATE INDEX IF NOT EXISTS idx_reviews_trainer ON trainer_reviews(trainer_id);
...
CREATE INDEX IF NOT EXISTS idx_availability_trainer_day ON trainer_availabilities(trainer_id, day_of_week);
...
CREATE INDEX IF NOT EXISTS idx_workout_plans_exercises_gin ON workout_plans USING GIN (exercises);
...
CREATE INDEX IF NOT EXISTS idx_workouts_exercises_gin ON workouts USING GIN (exercises);
...
CREATE INDEX IF NOT EXISTS idx_meals_athlete_date ON meals(athlete_id, date);
CREATE INDEX IF NOT EXISTS idx_meals_items_gin ON meals USING GIN (items);
...
CREATE INDEX IF NOT EXISTS idx_bm_athlete_date ON body_measurements(athlete_id, date);
CREATE INDEX IF NOT EXISTS idx_bm_athlete_weight ON body_measurements(athlete_id, weight);
CREATE INDEX IF NOT EXISTS idx_bm_chest   ON body_measurements(athlete_id, ((parts->'chest'->>'value')::numeric))   WHERE parts ? 'chest';
CREATE INDEX IF NOT EXISTS idx_bm_waist   ON body_measurements(athlete_id, ((parts->'waist'->>'value')::numeric))   WHERE parts ? 'waist';
CREATE INDEX IF NOT EXISTS idx_bm_hips    ON body_measurements(athlete_id, ((parts->'hips'->>'value')::numeric))    WHERE parts ? 'hips';
CREATE INDEX IF NOT EXISTS idx_bm_bicep_left  ON body_measurements(athlete_id, ((parts->'bicepLeft'->>'value')::numeric))  WHERE parts ? 'bicepLeft';
CREATE INDEX IF NOT EXISTS idx_bm_bicep_right ON body_measurements(athlete_id, ((parts->'bicepRight'->>'value')::numeric)) WHERE parts ? 'bicepRight';
CREATE INDEX IF NOT EXISTS idx_bm_forearm_left  ON body_measurements(athlete_id, ((parts->'forearmLeft'->>'value')::numeric))  WHERE parts ? 'forearmLeft';
CREATE INDEX IF NOT EXISTS idx_bm_forearm_right ON body_measurements(athlete_id, ((parts->'forearmRight'->>'value')::numeric)) WHERE parts ? 'forearmRight';
CREATE INDEX IF NOT EXISTS idx_bm_thigh_left    ON body_measurements(athlete_id, ((parts->'thighLeft'->>'value')::numeric))    WHERE parts ? 'thighLeft';
CREATE INDEX IF NOT EXISTS idx_bm_thigh_right   ON body_measurements(athlete_id, ((parts->'thighRight'->>'value')::numeric))   WHERE parts ? 'thighRight';
CREATE INDEX IF NOT EXISTS idx_bm_calf_left     ON body_measurements(athlete_id, ((parts->'calfLeft'->>'value')::numeric))     WHERE parts ? 'calfLeft';
CREATE INDEX IF NOT EXISTS idx_bm_calf_right    ON body_measurements(athlete_id, ((parts->'calfRight'->>'value')::numeric))    WHERE parts ? 'calfRight';
CREATE INDEX IF NOT EXISTS idx_bm_neck          ON body_measurements(athlete_id, ((parts->'neck'->>'value')::numeric))          WHERE parts ? 'neck';
CREATE INDEX IF NOT EXISTS idx_bm_shoulder      ON body_measurements(athlete_id, ((parts->'shoulder'->>'value')::numeric))      WHERE parts ? 'shoulder';
CREATE INDEX IF NOT EXISTS idx_bm_parts_gin ON body_measurements USING GIN (parts);
...
CREATE INDEX IF NOT EXISTS idx_wpa_athlete ON workout_plan_assignments(athlete_id);
CREATE INDEX IF NOT EXISTS idx_wpa_trainer ON workout_plan_assignments(trainer_id);
`
...
func main() {
	...
	fmt.Println("  Seed data: muscle_groups, equipment_definitions")
}
