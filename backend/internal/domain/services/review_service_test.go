...
func newReviewTestRelationship(relationshipID, trainerID, athleteID string, status models.RelationshipStatus) *models.Relationship {
...
func (suite *ReviewServiceTestSuite) TestCreateReview_Success() {
	...
	relationship := testutils.NewTestRelationship("rel-123", trainerID, athleteID, models.RelationshipStatusActive)
...
func (suite *ReviewServiceTestSuite) TestCreateReview_RelationshipWithDifferentTrainer() {
	...
	relationship := testutils.NewTestRelationship("rel-123", "different-trainer", athleteID, models.RelationshipStatusActive)
...
func (suite *ReviewServiceTestSuite) TestCreateReview_RelationshipNotActive() {
	...
	relationship := testutils.NewTestRelationship("rel-123", trainerID, athleteID, models.RelationshipStatusPending)
