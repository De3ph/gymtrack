...
func (r *CouchbaseWorkoutPlanRepository) Create(ctx context.Context, plan *models.WorkoutPlan) error {
	...
	_, err := collection.Insert(strconv.Itoa(plan.PlanID), plan, &gocb.InsertOptions{
		Context: ctx,
	})
	if err != nil {
...
func (r *CouchbaseWorkoutPlanRepository) GetByID(ctx context.Context, planID int) (*models.WorkoutPlan, error) {
	collection := r.bucket.Scope(config.ScopeDefault).Collection(config.CollectionWorkoutPlans)
	result, err := collection.Get(strconv.Itoa(planID), &gocb.GetOptions{
		Context: ctx,
	})
	if err != nil {
...
func (r *CouchbaseWorkoutPlanRepository) GetByTrainerID(ctx context.Context, trainerID int) ([]*models.WorkoutPlan, error) {
...
func (r *CouchbaseWorkoutPlanRepository) Update(ctx context.Context, plan *models.WorkoutPlan) error {
	...
	collection := r.bucket.Scope(config.ScopeDefault).Collection(config.CollectionWorkoutPlans)
	_, err := collection.Replace(strconv.Itoa(plan.PlanID), plan, &gocb.ReplaceOptions{
		Context: ctx,
	})
	if err != nil {
		if errors.Is(err, gocb.ErrDocumentNotFound) {
...
func (r *CouchbaseWorkoutPlanRepository) Delete(ctx context.Context, planID int) error {
	collection := r.bucket.Scope(config.ScopeDefault).Collection(config.CollectionWorkoutPlans)
	_, err := collection.Remove(strconv.Itoa(planID), &gocb.RemoveOptions{
		Context: ctx,
	})
	if err != nil {
		if errors.Is(err, gocb.ErrDocumentNotFound) {
...
func (r *CouchbaseWorkoutPlanAssignmentRepository) Create(ctx context.Context, assignment *models.WorkoutPlanAssignment) error {
	_, err := r.bucket.Scope(config.ScopeDefault).Collection(config.CollectionWorkoutPlanAssignments).Insert(strconv.Itoa(assignment.AssignmentID), assignment, &gocb.InsertOptions{
		Context: ctx,
	})
	if err != nil {
...
func (r *CouchbaseWorkoutPlanAssignmentRepository) GetByPlanID(ctx context.Context, planID int) ([]*models.WorkoutPlanAssignment, error) {
...
func (r *CouchbaseWorkoutPlanAssignmentRepository) GetByAthleteID(ctx context.Context, athleteID int) ([]*models.WorkoutPlanAssignment, error) {
...
func (r *CouchbaseWorkoutPlanAssignmentRepository) GetByAthleteAndPlan(ctx context.Context, athleteID int, planID int) (*models.WorkoutPlanAssignment, error) {
...
func (r *CouchbaseWorkoutPlanAssignmentRepository) GetByTrainerID(ctx context.Context, trainerID int) ([]*models.WorkoutPlanAssignment, error) {
...
func (r *CouchbaseWorkoutPlanAssignmentRepository) DeleteByPlanID(ctx context.Context, planID int) error {
