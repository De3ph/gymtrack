...
func (m *MockCommentRepository) GetByID(id int) (*models.Comment, error) {
	args := m.Called(id)
	if args.Get(0) == nil {
...
func (m *MockCommentRepository) GetByTarget(t models.TargetType, id int) ([]*models.Comment, error) {
	args := m.Called(t, id)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockCommentRepository) Delete(id int) error { return m.Called(id).Error(0) }

func (m *MockCommentRepository) GetByAuthor(authorID int) ([]*models.Comment, error) {
...
func (m *MockCommentRepository) GetReplies(parentCommentID int) ([]*models.Comment, error) {
...
// Test data factories
func CreateTestComment(id int, targetType models.TargetType, targetID, authorID int, authorRole models.AuthorRole, content string) *models.Comment {
	c := models.NewComment(targetType, targetID, authorID, authorRole, content, nil)
	c.CommentID = id
	c.CreatedAt = time.Now().UTC()
	return c
}
func CreateTestCommentWithParent(id int, targetType models.TargetType, targetID, authorID int, authorRole models.AuthorRole, content string, parentID *int) *models.Comment {
	c := models.NewComment(targetType, targetID, authorID, authorRole, content, parentID)
	c.CommentID = id
	c.CreatedAt = time.Now().UTC()
	return c
}
func CreateTestAvailabilitySlot(id, trainerID int, day int, start, end string) models.TrainerAvailability {
