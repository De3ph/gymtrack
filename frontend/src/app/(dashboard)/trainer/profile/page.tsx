...
export default function TrainerProfilePage() {
  ...
  const updateSlot = (index: number, field: keyof TrainerAvailability, value: string | number | boolean) => {
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                onChange={(e) => setProfile({ ...profile, isAvailableForNewClients: e.target.checked })}
              />
              ...
              return (
                <div key={day} className="border-b pb-4 last:border-0">
                  ...
                  {daySlots.map((slot, slotIndex) => {
                    ...
                    return (
                      <div key={slot.availabilityId} className="flex gap-2 items-center mb-2">
                        <Input
                          type="time"
                        ...
                        <Input
                          ...
                          className="w-32"
                        />
                        <Button variant="destructive" size="sm" onClick={() => removeSlot(actualIndex)}>
                          X
                        </Button>
                      </div>
                    )
