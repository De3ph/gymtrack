...
export default function ProfilePage() {
  ...
  if (!currentUser) {
    return <div className="text-center">{t('not_found')}</div>;
  }
              ...
              <>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <form.Field name="weight">
                    {(field) => (
                      <Field>
                        <FieldLabel htmlFor="weight">{t('fields.weight')} ({t('units.kg')})</FieldLabel>
                        <Input
                          value={field.state.value}
                          onChange={(e) => field.handleChange(e.target.value)}
                          onBlur={field.handleBlur}
                ...
                <form.Field name="height">
                  {(field) => (
                    <Field>
                      <FieldLabel htmlFor="height">{t('fields.height')} ({t('units.cm')})</FieldLabel>
                      <Input
                        value={field.state.value}
                        onChange={(e) => field.handleChange(e.target.value)}
                        onBlur={field.handleBlur}
                ...
                <form.Field name="fitnessGoals">
                  {(field) => (
                    <Field>
                      <FieldLabel htmlFor="fitnessGoals">{t('fields.fitness_goals')}</FieldLabel>
                      <textarea
                        value={field.state.value}
                        onChange={(e) => field.handleChange(e.target.value)}
                        onBlur={field.handleBlur}
            ...
            {currentUser.role === 'trainer' && (
              <>
                <form.Field name="certifications">
                  {(field) => (
                    <Field>
                      <FieldLabel htmlFor="certifications">{t('fields.certifications')}</FieldLabel>
                      <Input
                        value={field.state.value}
                        onChange={(e) => field.handleChange(e.target.value)}
                        onBlur={field.handleBlur}
                ...
                <form.Field name="specializations">
                  {(field) => (
                    <Field>
                      <FieldLabel htmlFor="specializations">{t('fields.specializations')}</FieldLabel>
                      <Input
                        value={field.state.value}
                        onChange={(e) => field.handleChange(e.target.value)}
                        onBlur={field.handleBlur}
