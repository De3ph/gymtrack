    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Generate an invitation code that athletes can use to connect with you.
          ...
          {!code ? (
            <div className="flex flex-col items-center space-y-4 py-4">
              <p className="text-center text-sm text-muted-foreground">
                Click the button below to generate a unique invitation code for an athlete.
              </p>
            ...
            <div className="space-y-4">
              ...
              {expiresAt && (
                <p className="text-sm text-muted-foreground">
                  Expires on {new Date(expiresAt).toLocaleDateString()} at{" "}
              ...
              <div className="rounded-lg border bg-muted p-4">
                <p className="text-sm">
                  <strong>Instructions:</strong> Share this code with your athlete. They can
                  enter it in their dashboard to connect with you as their trainer.
                </p>
              </div>
